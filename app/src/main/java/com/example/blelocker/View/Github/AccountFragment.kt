...
import com.example.blelocker.databinding.FragmentAccountBinding
    ...
    private fun deleteUser() {
        viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO){
            cognitoViewModel.LogOut { LogOutRequest ->
                when(LogOutRequest){
                    com.example.blelocker.CognitoUtils.LogOutRequest.SUCCESS -> {
                    ...
                    com.example.blelocker.CognitoUtils.LogOutRequest.FAILURE -> {
                        viewLifecycleOwner.lifecycleScope.launch(Dispatchers.Main){
